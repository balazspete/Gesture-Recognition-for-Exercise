...
public class Gesture_VerticalJump implements Gesture {
	
	public boolean[] ENABLED_AXES = new boolean[]{ false, true, false };
	...
	public final double[][] GESTURE_MODEL = new double[][] {
		...
		//{ 0.0, 0.0, 5.4003724394785735, 21.876268965517287, 0.7448789571694583, 295.57822500000066 }
	};
